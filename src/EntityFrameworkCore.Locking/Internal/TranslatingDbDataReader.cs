...
internal sealed class TranslatingDbDataReader : DbDataReader
{
    ...
    public override Task<bool> ReadAsync(CancellationToken cancellationToken) => WrapAsync(() => _inner.ReadAsync(cancellationToken));
    public override bool NextResult() => Wrap(() => _inner.NextResult());
    public override Task<bool> NextResultAsync(CancellationToken cancellationToken) => WrapAsync(() => _inner.NextResultAsync(cancellationToken));
